...
for (i in 1:n_iterations) {
  ...
  results <- bplapply(1:n_gene, process_gene, n_gene = n_gene, z_t_0 = z_t_0, beta_mu_sigmatop1800 = beta_mu_sigmatop1800, Num_t = Num_t, stage_num = stage_num, Num_cell = Num_cell, dm_ratio = dm_ratio)
